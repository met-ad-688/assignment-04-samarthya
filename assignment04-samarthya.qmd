...
{chr(10).join([f"**{model_name}:**" + chr(10) + 
               f"- Count: {len(all_predictions_df[all_predictions_df['Model'] == model_name]):,}" + chr(10) +
               f"- Avg Actual Salary: ${all_predictions_df[all_predictions_df['Model'] == model_name]['Actual_Salary'].mean():,.2f}" + chr(10) +
               f"- Avg Predicted Salary: ${all_predictions_df[all_predictions_df['Model'] == model_name]['Predicted_Salary'].mean():,.2f}" + chr(10) +
               f"- Avg Absolute Error: ${all_predictions_df[all_predictions_df['Model'] == model_name]['Absolute_Error'].mean():,.2f}"
