...
"""))
    ...
    print(f"⚠️ Error calculating data split statistics: {str(e)}")
...
"""))
        ...
        display(Markdown("""
::: {.callout-warning}
## ⚠️ Could Not Calculate Model Selection Metrics
...
"""))
    ...
    display(Markdown("""
::: {.callout-warning}
## ⚠️ No Models Available for Visualization
...
"""))
    ...
    print("⚠️ Insufficient data for comprehensive summary")
```
